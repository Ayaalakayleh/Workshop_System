...
const getIconClass = (prefix, icon) => {
    ...
    switch (prefix) {
        case 'svg':
            ...
            return `<svg class="sa-icon ${weightClass}${fillClass}"><use href="smartadmin-5-styles/icons/sprite.svg#${cleanIcon}"></use></svg>`;
        case 'fal':
                                ...
                                <div class="layer-actions d-flex gap-1">
                                    ...
                                    <div class="drag-handle btn btn-icon btn-default-outline">
                                        <svg class="sa-icon sa-thin">
                                            <use href="smartadmin-5-styles/icons/sprite.svg#more-vertical"></use>
                                        </svg>
                                    </div>
                                </div>
                            </div>
